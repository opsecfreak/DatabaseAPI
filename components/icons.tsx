...
export const SupabaseIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M18.63,3.09,12.01,7.24,5.37,3.09,12,0ZM11.23,8.08,5.37,4.48V13.34L11.23,17V8.08ZM12.77,8.08V17l5.86-3.66V4.48Z" />
    <path d="M12,24l-7-4.2V9.91l7,4.2V24Z" />
    <path d="M12,24l7-4.2V9.91l-7,4.2V24Z" />
  </svg>
);
